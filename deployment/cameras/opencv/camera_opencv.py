...
class OpenCVCamera(Camera):
    ...
    Example:
        ```python
        from deployment.cameras.opencv import OpenCVCamera
        from deployment.cameras.configuration_opencv import OpenCVCameraConfig, ColorMode, Cv2Rotation
    ...
    def __init__(self, config: OpenCVCameraConfig):
        ...
        self.flip_vertical: bool = config.flip_vertical
    ...
    def _postprocess_image(self, image: NDArray[Any], color_mode: ColorMode | None = None) -> NDArray[Any]:
        ...
        if self.flip_vertical:
            processed_image = cv2.flip(processed_image, 0)  # 0 = flip around x-axis (vertical flip)
