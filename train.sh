...
# =================== 需要改动的配置 ===================
# 模型和数据集配置
dataset_id=${1:-rm_umi_dual_260618_pick_majiang_256}  # 数据集名
...
# 数据配置
wrist_only=${6:-false}  # true | false
tactile_mode=${7:-none}  # none | as_image | encode
state_mode=${8:-joint}  # none | joint | episode_ee
action_mode=${9:-joint}  # none | joint | relative_ee
