...
# =================== 需要改动的配置 ===================
# 模型和数据集配置
dataset_id=${1:-rm_umi_dual_260617_pen_place_cap_notop_undist_256}  # 数据集名
policy_type=${2:-pi05}          # act | diffusion | pi05 | starvla_groot
...
state_mode=${8:-absolute_ee}  # none | joint | episode_ee | absolute_ee
